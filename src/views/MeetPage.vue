...
<script setup>
  ...
  // Parse the date prop (YYYY-MM-DD-HH-mm) into a native Date object
...
//   })
  ...
  // Check if it is meeting time reactively based on currentTime
  ...
  onMounted(() => {
    ...
    const updateCountdown = () => {
      ...
      // Performance: Use native Date arithmetic instead of date-fns
