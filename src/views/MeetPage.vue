...
//   })
  ...
  onMounted(() => {
    ...
    timer = setInterval(() => {
      ...
      days.value = Math.floor(diffInSeconds / 86400);
      hours.value = Math.floor((diffInSeconds % 86400) / 3600);
      minutes.value = Math.floor((diffInSeconds % 3600) / 60);
      seconds.value = diffInSeconds % 60;
    }, 1000);
  });
  onUnmounted(() => {
    clearInterval(timer);
