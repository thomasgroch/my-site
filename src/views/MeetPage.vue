...
//   })
  ...
  const updateCountdown = () => {
    ...
    const timeDifferenceInSeconds = Math.max(0, Math.floor(diff / 1000));

    days.value = Math.floor(timeDifferenceInSeconds / (3600 * 24));
    hours.value = Math.floor((timeDifferenceInSeconds % (3600 * 24)) / 3600);
    minutes.value = Math.floor((timeDifferenceInSeconds % 3600) / 60);
