...
<script setup>
  ...
  const eventTime = computed(() => {
    ...
    // Native Date: year, monthIndex (0-11), day, hours, minutes
...
//   })
   ...
   * reduces the MeetPage chunk size from 44.97 kB to 10.91 kB (~75% reduction).
   */
  ...
  onMounted(() => {
    ...
    // Update immediately to avoid initial zero-flicker
    updateCountdown();
